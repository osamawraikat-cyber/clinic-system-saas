    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          side === "left"
            ? "group-data-[side=left]:start-0 group-data-[collapsible=offcanvas]:start-[calc(var(--sidebar-width)*-1)]"
            : "group-data-[side=right]:end-0 group-data-[collapsible=offcanvas]:end-[calc(var(--sidebar-width)*-1)]",
